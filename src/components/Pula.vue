<template>
<div>
    <b-container fluid class="bv-example-row mt-4" id="destination">
        <b-row>
            <b-col>
                <b-card no-body class="overflow-hidden">
                    <b-row no-gutters>
                        <b-col md="6">
                            <b-card-img :src="require('../assets/arena.jpg')" class="rounded-0"></b-card-img>
                        </b-col>
                        <b-col md="6">
                            <b-card-body class="text-primary" title="Pula" id="pula">
                                <b-card-text class="text-dark">
                                    <h2 class="mt-4">Airport Pula --> Pula</h2>
                                    <h6 class="mt-4">250 HRK</h6>
                                    <p class="mt-4">One way</p>
                                </b-card-text>
                                <b-button
                                    @click="modaldata('Pula',250,'primary')"
                                    size="lg"
                                    class="mt-4"
                                    block
                                    variant="primary"
  ...
  <b-modal hide-footer  id="modal-1" :title="taxi">
...
export default {
    data(){
        ...
        options: [
          ...
          { value: 'b', text: 'Van up to 8 passengers (300HRK)' },
